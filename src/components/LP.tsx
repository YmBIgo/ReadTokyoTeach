            ...
            <div className="main-section4">
                ...
                <div className="main-section4-card">
                    <h4>
                        <span>03</span>
                        <span className="main-section4-title-content">
                            コードを<strong>「簡単に読める！」</strong><br />
                            <small>重要なロジックの流れを選んで表示</small>
                        </span>
                    </h4>
                    <div>
                        <h3>設計や俯瞰図のみならず、関数の流れを１つ１つルートの関数から再現することもできます。</h3>
                        <img className="main-section4-card-image" src="./linux_tokyo_1_read.png" />
                        <p>
                            私たちのソリューションは、設計や俯瞰図だけではなく、コードの詳細も再現できる仕組みを作りました。
                            <br />
                            木構造にある任意の関数から選べば、以下のことができます。
                            <ol>
                                <li>そこに行き着くまでの関数の経路を関数１つ１つを辿って再現</li>
                                <li>そこに行き着くまでの関数の内容を説明するChatGPT向けのプロンプトを生成</li>
                            </ol>
                        </p>
                        <p>
                            <a className="button" href="https://linux.tokyo/trees/read_4_nvme_queue_rq__nvme_queue_rq_to_writel?id=a5ba70472097b57d324f91ff" target="_blank">Linuxカーネルでの例</a>
                        </p>
                    </div>
                </div>
            </div>
            <div className="main-section5">
                ...
                <div className="main-section5-inner">
                    ...
                    <div className="main-section5-card">
                        ...
                        <h4>常駐型開発支援</h4>
                        <p>週2〜3日程度の常駐型開発支援で、現場のコードの教材を作ります。1週間1万行教材化を目安にみてください。</p>
                    </div>
                    <div className="main-section5-card">
